  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        exit={{ opacity: 0, y: -8 }}
        transition={{ duration: 0.25, ease: 'easeInOut' }} // Snappier transitions optimized for mobile screens
      >
  ...
  return (
    <Router>
      ...
      <div className="min-h-screen bg-white text-slate-900 selection:bg-blue-100 selection:text-blue-600 flex flex-col justify-between font-sans antialiased overflow-x-hidden">
        ...
        {/* Main Content Area - Padding-top prevents content from slipping under fixed Navbar */}
        ...
        {/* Responsive Floating WhatsApp Action Widget */}
        <motion.div
        ...
        >
          {/* Tooltip Hover Badge - Only visible on desktop/hover displays */}
          ...
          {/* Button - Scaled size for touch elements on mobile screens */}
          <motion.a
