...
const TelephoneNetworking = () => {
  // --- Enterprise SEO ---
  useEffect(() => {
    document.title = "Enterprise Networking, Structured Cabling & PABX | BugsFixer Pakistan";
    ...
    setMetaTag('name', 'description', 'BugsFixer Pakistan provides enterprise Cat6/Fiber optic structured cabling, Cisco & MikroTik switch routing, and Panasonic & Grandstream PABX intercom systems nationwide.');
    setMetaTag('name', 'keywords', 'Structured Cabling Pakistan, Cisco Network Installer, PABX Exchange Peshawar, Fiber Optic Splicing, IP-PBX Setup, MikroTik Routerboard, Ubiquiti UniFi Access Points');
  }, []);
