...
const CCTV = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>CCTV Installation & Surveillance Security | BugsFixer Pakistan</title>
        <meta name="description" content="Expert CCTV camera installation and surveillance setup in Pakistan. IP & Analog systems, Hikvision & Dahua integrations for offices, factories, and schools." />
        <meta name="keywords" content="CCTV Installation Pakistan, Hikvision Installer Peshawar, Dahua IP Cameras, NVR Setup, Security System Integration, ColorVu Night Vision" />
        <link rel="canonical" href="https://bugsfixerweb.pp.ua/cctv" />

        {/* Open Graph Tags (Facebook & WhatsApp Previews) */}
        <meta property="og:title" content="CCTV Installation & Surveillance Security | BugsFixer Pakistan" />
        <meta property="og:description" content="Expert CCTV camera installation and surveillance setup in Pakistan. IP & Analog systems, Hikvision & Dahua integrations for offices, factories, and schools." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://bugsfixerweb.pp.ua/cctv" />
        <meta property="og:image" content="https://images.unsplash.com/photo-1557597774-9d273605dfa9?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80" />

        {/* Twitter Card Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="CCTV Installation & Surveillance Security | BugsFixer" />
        <meta name="twitter:description" content="Tier-1 Security Infrastructure featuring 4K Ultra-HD, Smart AI analytics, and remote mobile synchronization." />
        <meta name="twitter:image" content="https://images.unsplash.com/photo-1557597774-9d273605dfa9?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80" />
      </Helmet>
