...
const Electronics = () => {
  return (
    <>
      ...
      <Helmet>
        <title>Professional Electronics Repair Services | BugsFixer Pakistan</title>
        <meta name="description" content="Expert component-level electronics repair in Peshawar & across Pakistan. We repair industrial controllers, power supplies (SMPS), LED TV logic boards, and office equipment." />
        <meta name="keywords" content="Electronics Repair Pakistan, PCB repair Peshawar, SMD soldering, power supply repair, inverter repair, LED TV logic board repair Peshawar, industrial board repair" />
        <link rel="canonical" href="https://bugsfixerweb.pp.ua/electronics" />

        {/* Open Graph Tags (Facebook & WhatsApp Previews) */}
        <meta property="og:title" content="Professional Electronics Repair Services | BugsFixer Pakistan" />
        <meta property="og:description" content="Component-level diagnostics, SMD PCB rework, and board-level repairs for consumer, commercial, and industrial equipment." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://bugsfixerweb.pp.ua/electronics" />
        ...
        <meta name="twitter:title" content="Electronics Repair Services | BugsFixer Pakistan" />
        <meta name="twitter:description" content="Expert PCB & logic board repair services for TVs, industrial controllers, inverters, and office equipment." />
