...
const Security = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Biometric Access Control & Smart Door Locks | BugsFixer Pakistan</title>
        <meta name="description" content="BugsFixer Pakistan provides enterprise biometric time-attendance machines, face recognition access terminals, electromagnetic door locks, and fire safety systems nationwide." />
        <meta name="keywords" content="Biometric Attendance Pakistan, ZKTeco Terminal Peshawar, EM Door Lock, Hikvision Access Control, Fire Alarm System, Turnstile Gate Automation, Peshawar smart door lock" />
        <link rel="canonical" href="https://bugsfixerweb.pp.ua/security" />

        {/* Open Graph Tags (Facebook & WhatsApp Previews) */}
        <meta property="og:title" content="Biometric Access Control & Fire Safety | BugsFixer Pakistan" />
        <meta property="og:description" content="Enterprise face recognition terminals, biometric attendance systems, electromagnetic door locks, and smart fire alarm systems." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://bugsfixerweb.pp.ua/security" />
        <meta property="og:image" content="https://images.unsplash.com/photo-1558002038-1055907df827?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80" />

        {/* Twitter Card Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Biometric Access Control & Smart Door Locks | BugsFixer" />
        <meta name="twitter:description" content="Enterprise perimeter defense, AI facial recognition, smart magnetic locks, and turnstile barrier setups." />
        <meta name="twitter:image" content="https://images.unsplash.com/photo-1558002038-1055907df827?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80" />
      </Helmet>
