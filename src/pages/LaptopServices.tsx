...
import { Laptop, Cpu, Zap, CheckCircle2, Settings } from 'lucide-react';
...
const LaptopServices = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Used Business Laptops & Chip-Level Repair | BugsFixer Pakistan</title>
        <meta name="description" content="BugsFixer Pakistan offers certified used business laptops (Dell, HP, Lenovo) and expert chip-level motherboard, GPU, and BGA reballing repairs in Peshawar and nationwide." />
        <meta name="keywords" content="Used Business Laptops Peshawar, Laptop Repair Pakistan, Chip Level Motherboard Fix, NVMe SSD Upgrade, Dell Latitude, HP EliteBook, ThinkPad, laptop repair Peshawar" />
        <link rel="canonical" href="https://bugsfixerweb.pp.ua/laptopservices" />

        {/* Open Graph Tags (Facebook & WhatsApp Previews) */}
        <meta property="og:title" content="Used Business Laptops & Chip-Level Repair | BugsFixer Pakistan" />
        <meta property="og:description" content="Precision diagnostics, micro-soldering motherboard repairs, and certified corporate laptop procurement." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://bugsfixerweb.pp.ua/laptopservices" />
        <meta property="og:image" content="https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80" />

        {/* Twitter Card Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Business Laptops & Motherboard Repair | BugsFixer" />
        <meta name="twitter:description" content="Precision hardware tuning, BGA rework, SSD upgrades, and deep data recovery." />
        <meta name="twitter:image" content="https://images.unsplash.com/photo-1588872657578-7efd1f1555ed?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80" />
      </Helmet>
