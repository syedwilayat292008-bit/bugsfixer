...
const About = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>About BugsFixer Pakistan | 15+ Years of IT & ERP Software Excellence</title>
        <meta name="description" content="Discover BugsFixer Pakistan. Complete IT hardware, networking, custom CCTV installations, biometric systems, and Max Sale ERP developers based in Peshawar with nationwide reach." />
        <meta name="keywords" content="About BugsFixer, IT Company Pakistan, CCTV Experts Peshawar, Hardware Networking, Max Sale ERP developers, IT service center KPK" />
        <link rel="canonical" href="https://bugsfixerweb.pp.ua/about" />
        
        {/* Open Graph Tags (Facebook & WhatsApp Previews) */}
        <meta property="og:title" content="About BugsFixer Pakistan | Driving IT & ERP Excellence" />
        <meta property="og:description" content="Explore our timeline, core values, and ecosystem designed to scale your commercial infrastructure securely." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://bugsfixerweb.pp.ua/about" />
        <meta property="og:image" content="https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80" />
        
        {/* Twitter Card Tags */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="About BugsFixer Pakistan | 15+ Years of IT Services" />
        <meta name="twitter:description" content="Domestic and international-grade enterprise IT, high-definition security camera solutions, and system integrations." />
        <meta name="twitter:image" content="https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-1.2.1&auto=format&fit=crop&w=1200&q=80" />
      </Helmet>
        ...
        <section className="py-32 bg-[#0B1120] text-white relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 lg:px-8 relative z-10">
            ...
            >
              ...
              <h2 className="text-4xl lg:text-6xl font-black mb-10 tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-white to-slate-400">
                Our Working Ideology
              </h2>
              
              <blockquote className="text-xl lg:text-2xl text-slate-300 leading-relaxed font-medium italic border-l-4 border-blue-500 pl-8 text-left max-w-3xl mx-auto">
